...
class OpenStack_1_1_NodeDriver(OpenStackNodeDriver):
    ...
    def _to_floating_ip(self, obj):
        return OpenStack_1_1_FloatingIpAddress(id=obj.get('id'),
                                               ip_address=obj.get('ip'),
                                               pool=obj.get('pool'),
                                               node_id=obj.get('instance_id'),
                                               driver=self)
    ...
    def ex_list_floating_ips(self):
        ...
        """
        ip = self.connection.request('/os-floating-ips').object
        return self._to_floating_ips(ip)
...
class OpenStack_1_1_FloatingIpAddress(object):
    ...
    def __repr__(self):
        return ('<OpenStack_1_1_FloatingIpAddress: id=%s, ip_address=%s,'
                ' pool=%s, instance_id=%s, driver=%s>'
                % (self.id, self.ip_address, self.pool, self.node_id,
                   self.driver))
